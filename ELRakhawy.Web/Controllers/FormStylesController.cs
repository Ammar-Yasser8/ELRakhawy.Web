...
namespace ELRakhawy.Web.Controllers
{
    public class FormStylesController : Controller
    {
        ...
        private readonly List<string> _businessOperationForms = new List<string>
        {
            ...
            // Raw Materials Operations (عمليات المواد الخام)
            "اضافة وارد مواد خام", "اضافة صادر مواد خام", "تعديل مخزون مواد خام", "جرد مواد خام",
            "فحص جودة مواد خام", "تخزين مواد خام", "اتلاف مواد خام", "ارجاع مواد خام",
